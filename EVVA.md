...
> Coding conventions, the release workflow, and CHANGELOG rules live in
> **[CLAUDE.md](CLAUDE.md)**. Contributor onboarding (build, test, branch/PR flow) lives in
> **[CONTRIBUTING.md](CONTRIBUTING.md)**. User-facing docs live in
